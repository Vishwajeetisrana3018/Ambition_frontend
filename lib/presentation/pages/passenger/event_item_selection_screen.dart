...
class EventItemSelectionScreen extends StatefulWidget {
  const EventItemSelectionScreen(
      {super.key,
  ...
  @override
  State<EventItemSelectionScreen> createState() =>
      _EventItemSelectionScreenState();
}

class _EventItemSelectionScreenState extends State<EventItemSelectionScreen> {
  ...
  void initState() {
    super.initState();
    isRideAndMoveType = widget.moveType == 'ride & move';
  }
                              ...
                              TextButton(
                                onPressed: () {
                                  ...
                                  Map<String, dynamic> repeatJob = {
                                    ...
                                    "isEventJob": true,
                                    "originLat": widget.pickupAddress.lat,
                                    "originLong": widget.pickupAddress.lng,
                                    "originName": widget.pickupAddress.name,
                                    "originAddress":
                                        widget.pickupAddress.formattedAddress,
                                    "destinationLat": widget.dropoffAddress.lat,
                                    "destinationLong":
                                        widget.dropoffAddress.lng,
                                    "destinationName":
                                        widget.dropoffAddress.name,
                                    "destinationAddress":
                                        widget.dropoffAddress.formattedAddress,
                                    if (isRideAndMoveType)
                            ...
                            Navigator.of(context).pushNamed(
                              ...
                              arguments: {
                                ...
                                "originAddress":
                                    widget.pickupAddress.formattedAddress,
                                "destinationLat": widget.dropoffAddress.lat,
                                "destinationLong": widget.dropoffAddress.lng,
                                "destinationName": widget.dropoffAddress.name,
                                "destinationAddress":
                                    widget.dropoffAddress.formattedAddress,
                                if (isRideAndMoveType)
                                  "passengersCount": passengersCount,
