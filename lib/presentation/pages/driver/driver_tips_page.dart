...
class DriverTipsPage extends StatefulWidget {
  const DriverTipsPage({super.key});

  @override
  State<DriverTipsPage> createState() => _DriverTipsPageState();
}

class _DriverTipsPageState extends State<DriverTipsPage> {
  @override
  void initState() {
    super.initState();
    context
        .read<InstructionBloc>()
        .add(const GetInstructionsByUserTypeEvent('driver'));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Driver Guidelines'),
      ),
